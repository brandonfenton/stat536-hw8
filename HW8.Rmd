...
Using `polyroot(c(1,-0.37,-0.15))`, the resultant roots are `r polyroot(c(1,-0.37,-0.15))[1]` and `r polyroot(c(1,-0.37,-0.15))[2]`.  Both of these numbers have absolute values greater than one, 
